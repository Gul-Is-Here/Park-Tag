        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        Expanded(
                          child: VehiclePhotoTile(
                            label: 'Front view',
                            imagePath: photos.isNotEmpty ? photos[0].path : null,
                        ...
                        Expanded(
                          child: VehiclePhotoTile(
                            label: 'Back view',
                            imagePath: photos.length > 1 ? photos[1].path : null,
                            onTap: () => _pickPhoto(context),
              ...
              Obx(() {
                final enoughPhotos =
                    controller.vehiclePhotos.length >= ReviewVehicleController.requiredVehiclePhotos;
